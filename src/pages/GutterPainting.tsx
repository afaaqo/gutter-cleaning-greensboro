            ...
            <div className="container mx-auto px-4">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="p-6 bg-green-50 rounded-lg">
                  ...
                  <h3 className="text-xl font-semibold mb-3 text-center">Premium Materials</h3>
                ...
                <div className="p-6 bg-green-50 rounded-lg">
                  ...
                  <h3 className="text-xl font-semibold mb-3 text-center">Expert Application</h3>
                  <p className="text-gray-600">Skilled technicians specializing in residential gutter painting.</p>
                </div>
                <div className="p-6 bg-green-50 rounded-lg">
                  <div className="flex justify-center mb-4">
                    <Palette className="w-12 h-12 text-green-800" />
                  </div>
                  <h3 className="text-xl font-semibold mb-3 text-center">Custom Colors</h3>
            ...
            <div className="container mx-auto px-4">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-white p-6 rounded-lg shadow-md">
                  ...
                  <h3 className="text-xl font-semibold mb-3 text-center">Surface Preparation</h3>
                  <p className="text-gray-600 text-center">Thorough cleaning and priming for optimal paint adhesion.</p>
                </div>
                <div className="bg-white p-6 rounded-lg shadow-md">
                  <div className="flex justify-center mb-4">
                    <Sparkles className="w-6 h-6 text-green-800" />
                  </div>
                  <h3 className="text-xl font-semibold mb-3 text-center">Quality Paint Application</h3>
                  <p className="text-gray-600 text-center">Professional gutter painting techniques for a flawless finish.</p>
                </div>
                <div className="bg-white p-6 rounded-lg shadow-md">
                  <div className="flex justify-center mb-4">
                    <Droplets className="w-6 h-6 text-green-800" />
                  </div>
                  <h3 className="text-xl font-semibold mb-3 text-center">Sealing Process</h3>
                  <p className="text-gray-600 text-center">Advanced gutter sealing for maximum protection.</p>
                </div>
                <div className="bg-white p-6 rounded-lg shadow-md">
                  <div className="flex justify-center mb-4">
                    <PaintBucket className="w-6 h-6 text-green-800" />
                  </div>
                  <h3 className="text-xl font-semibold mb-3 text-center">Final Inspection</h3>
                  <p className="text-gray-600 text-center">Thorough quality check for perfect results.</p>
                </div>
              </div>
            </div>
          </section>
